...
class InvoiceRenderer:
    ...
    def render(
       ...
       file_path = self.output_dir / f"INV-{invoice.id}.pdf"
        ...
        c.drawString(50, y, f"Customer: {customer.name} ({customer.email})")
        y -= 20
        ...
        for li in line_items:
            ...
            c.drawRightString(width - 50, y, li.amount.format())
            y -= 20

        y -= 20
        c.setFont("Helvetica-Bold", 12)
        c.drawString(50, y, "TOTAL")
        c.drawRightString(width - 50, y, invoice.total.format())
        y -= 30

        c.setFont("Helvetica", 10)
        c.drawString(50, y, f"Status: {invoice.status.value}")
        y -= 40

        c.setFont("Helvetica-Oblique", 9)
        c.drawString(50, y, "Generated by Billing Engine")
